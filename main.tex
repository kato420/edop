...
% EN EL PREÁMBULO
\usepackage{url}
\usepackage{mathtools}  % Añade esto en el preámbulo
\usepackage{hyperref}
\hypersetup{
...
\input{resumen}
% \newpage
\input{introduccion}   % Incluye pregunta investigación
\input{objetivos}      % Incluye objetivos
\input{justificacion}  % Incluye justificación
\newpage
\input{marco} % Marco teórico
\input{formulacion.tex}
% ... secciones previas ...
\input{metodologia}
